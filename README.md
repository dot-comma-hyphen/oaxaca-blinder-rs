...
> **Context Anchor:** This component is a pure statistical logic engine of the Macro System. For the overarching architecture and vision, see [SYSTEM_ARCHITECTURE](../SYSTEM_ARCHITECTURE.md) and [MISSION](../MISSION.md).
